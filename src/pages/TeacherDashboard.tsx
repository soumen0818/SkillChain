...
export default function TeacherDashboard() {
  ...
  const totalEarnings = courses.reduce((sum, course) => {
    const earnings = parseFloat(course.earnings.split(' ')[0]) || 0;
    return sum + earnings;
  }, 0).toFixed(1);
  ...
  const studentSatisfaction = totalReviews > 0
    ? Math.round((courses.reduce((sum, course) => sum + (course.rating * course.reviews), 0) / totalReviews) * 20)
    : 0;
          ...
          <TabsContent value="analytics" className="space-y-6">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Card className="p-6 text-center hover:shadow-lg hover:shadow-green-500/20 hover:-translate-y-1 hover:scale-105 transform transition-all duration-300 group border-0 bg-gradient-to-br from-green-50 to-white">
                ...
                <p className="text-2xl font-bold group-hover:text-green-600 transition-colors duration-300">{totalEnrollments}</p>
              ...
              <Card className="p-6 text-center hover:shadow-lg hover:shadow-yellow-500/20 hover:-translate-y-1 hover:scale-105 transform transition-all duration-300 group border-0 bg-gradient-to-br from-yellow-50 to-white">
                ...
                <p className="text-2xl font-bold group-hover:text-yellow-600 transition-colors duration-300">{averageRating}</p>
              ...
              <Card className="p-6 text-center hover:shadow-lg hover:shadow-green-500/20 hover:-translate-y-1 hover:scale-105 transform transition-all duration-300 group border-0 bg-gradient-to-br from-green-50 to-white">
                ...
                <p className="text-2xl font-bold group-hover:text-green-600 transition-colors duration-300">{totalEarnings}</p>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              <Card className="p-6 hover:shadow-lg hover:shadow-primary/10 hover:-translate-y-1 transform transition-all duration-300 border-0 bg-gradient-to-br from-white to-primary/5">
                <h4 className="text-lg font-semibold mb-4">Course Performance</h4>
                <div className="space-y-4">
                  {courses.slice(0, 3).map((course, index) => (
                    <div key={course.id} className="flex justify-between items-center hover:bg-primary/5 hover:scale-102 transform transition-all duration-300 p-2 rounded group">
                      <span className="group-hover:text-primary transition-colors duration-300">{course.title}</span>
                      <span className="font-medium group-hover:text-primary transition-colors duration-300">{course.earnings}</span>
                    </div>
                  ))}
                  {courses.length === 0 && (
                ...
                <div className="space-y-4">
                  <div className="space-y-2 hover:bg-secondary/5 p-3 rounded transition-all duration-300 group">
                    <div className="flex justify-between">
                      ...
                      <span className="text-sm group-hover:text-primary transition-colors duration-300">{averageCompletion}%</span>
                    </div>
                    <Progress value={averageCompletion} className="group-hover:scale-105 transition-transform duration-300" />
                  </div>
                  <div className="space-y-2 hover:bg-secondary/5 p-3 rounded transition-all duration-300 group">
                    <div className="flex justify-between">
                      <span className="text-sm group-hover:text-foreground transition-colors duration-300">Student Satisfaction</span>
                      <span className="text-sm group-hover:text-primary transition-colors duration-300">{studentSatisfaction}%</span>
                    </div>
                    <Progress value={studentSatisfaction} className="group-hover:scale-105 transition-transform duration-300" />
                  </div>
                  <div className="space-y-2 hover:bg-secondary/5 p-3 rounded transition-all duration-300 group">
                    <div className="flex justify-between">
                      <span className="text-sm group-hover:text-foreground transition-colors duration-300">Total Reviews</span>
                      <span className="text-sm group-hover:text-primary transition-colors duration-300">{totalReviews}</span>
                    </div>
                    <Progress value={Math.min(totalReviews * 2, 100)} className="group-hover:scale-105 transition-transform duration-300" />
                  </div>
                </div>
              </Card>
            </div>
